Config.Languages = {
    ...
    ['ja'] = { -- Japanese
        ['emotes'] = '~h~~p~ エモート 🎬',
        ['danceemotes'] = "~h~~p~ 🕺 ダンス エモート",
        ['animalemotes'] = "~h~~p~ 🐩 動物 エモート",
        ['propemotes'] = "~h~~p~ 📦 小道具 エモート",
        ['favoriteemotes'] = "~h~~y~ 🌟 お気に入り登録",
        ['favoriteinfo'] = "エモートを選択してお気に入りに登録します",
        ['rfavorite'] = "お気に入りをリセット",
        ['prop2info'] = "❓ 小道具エモートは末尾に配置されます",
        ['set'] = "(",
        ['setboundemote'] = ") エモートをお気に入りにしますか?",
        ['newsetemote'] = "~w~ がお気に入りされました。~g~CapsLock~w~ で使用できます",
        ['cancelemote'] = "~h~~r~ エモートをキャンセル🚷",
        ['cancelemoteinfo'] = "~r~X~w~ 再生中のエモートをキャンセルする",
        ['walkingstyles'] = "~h~~p~ 移動モーション 🚶🏻‍♂️",
        ['resetdef'] = "~h~~y~ リセットする",
        ['normalreset'] = "~h~~r~ 通常 (リセットする)",
        ['moods'] = "~h~~p~ 気分 😒",
        ['infoupdate'] = "~h~~g~ クレジット🤝🏻",
        ['infoupdateav'] = "情報 (更新が利用可能)",
        ['infoupdateavtext'] = "更新が利用可能です。最新版の取得は ~y~https://github.com/TayMcKenzieNZ/rpemotes~w~ から!",
        ['suggestions'] = "提案がある?",
        ['suggestionsinfo'] = "FiveMフォーラムの ~r~TayMcKenzieNZ~s~ にエモートや機能の提案をしてね✉️",
        ['notvaliddance'] = "は許可されていないダンスです。",
        ['notvalidemote'] = "は許可されていないエモートです。",
        ['nocancel'] = "キャンセルするエモートがありません。",
        ['maleonly'] = "このエモートは男性限定です。ごめんね!",
        ['emotemenucmd'] = "/emotemenu コマンドでアニメーションメニューが開けます。",
        ['shareemotes'] = "~h~~p~ 👫 シェア エモート",
        ['shareemotesinfo'] = "近くの人と一緒にエモートする",
        ['sharedanceemotes'] = "~h~~p~ 🕺 シェア ダンス",
        ['notvalidsharedemote'] = "は許可されていないシェアエモートです。",
        ['sentrequestto'] = "~y~ を誘いました。",
        ['nobodyclose'] = "誰も ~r~近くに~w~ いません。",
        ['doyouwanna'] = "~y~Y~w~ で許可, ~r~L~w~ で断る (~g~",
        ['refuseemote'] = "エモートは拒否されました。",
        ['makenearby'] = "コマンドで近くのプレイヤーが次のエモートをする:",
        ['useleafblower'] = "~y~G~w~ でブロワーを使う",
        ['camera'] = "~y~G~w~ でカメラのフラッシュする",
        ['makeitrain'] = "~y~G~w~ で雨を降らせる",
        ['pee'] = "~y~G~w~ を押しておしっこする",
        ['spraychamp'] = "~y~G~w~ を押してシャンパンスプレーする",
        ['stun'] = "~y~G~w~ でスタンガンを使う",
        ['smoke'] = "~y~G~w~ でタバコを吸う.",
        ['vape'] = "~y~G~w~ でVapeを吸う",
        ['bound'] = "",
        ['to'] = "を次のキーにバインドする: ",
        ['currentlyboundemotes'] = " 現在バインドされているエモート:",
        ['notvalidkey'] = "は無効なキーです。",
        ['keybinds'] = "🔢 キーバインド",
        ['keybindsinfo'] = "使用可能なキー: ",
        ['searchemotes'] = "~h~~y~ 🔍 エモートを検索する",
        ['searchinputtitle'] = "検索:",
        ['searchmenudesc'] = "%s 件の'~r~%s~w~'の検索結果:",
        ['searchnoresult'] = "'~r~%s~w~' の検索結果はありませんでした。",
        ['searchshifttofav'] = "左シフトを押しながらエンターキーでお気に入りに登録できます。",
        ['searchcantsetfav'] = "シェアエモートはお気に入りに登録できません。",
        ['invalidvariation'] = "テクスチャのバリエーションが無効です。有効な選択肢は次の通りです: %s",
        ['firework'] = "~y~G~w~ で花火を使う",
        ['poop'] = "~y~G~w~ で排便する",
        ['puke'] = "~y~G~w~ で嘔吐する",
        ['cut'] = "~y~G~w~ で切る",
        ['btn_select'] = "選択",
        ...
        ['btn_increment'] = "移動量",
        ['dead'] = "死亡中はエモートできません!",
        ['swimming'] = "水泳中はエモートできません!",
        ['notvalidpet'] = "わお! 誤ったモデルが検出されました🐕!",
        ['animaldisabled'] = "ごめんね! 動物エモートは無効化されています",
        ['adultemotedisabled'] = "あら! 成人向けエモートは無効化されています🔞",
        ['toggle_instructions'] = "指示を切り替える",
        ['exit_binoculars'] = "双眼鏡をやめる",
        ['toggle_binoculars_vision'] = "視覚モードを切り替える",
        ['exit_news'] = "ニュースカメラをやめる",
        ['toggle_news_vision'] = "視覚モードを切り替える",
        ['edit_values_newscam'] = "ニュース文を編集する",
        ['not_in_a_vehicle'] = "このアニメーションは車内ではできません",
        ['in_a_vehicle'] = "このアニメーションは車内でのみ使えます🚷",
        ['no_anim_crawling'] = "ほふく中はアニメーションできません",
        ['no_anim_right_now'] = "今はアニメーションできません",
    },
}
